...
public class SwimwearActivity extends BaseGalleryActivity<Swimwear> {
    ...
    private SwimwearAdapter swimwearAdapterer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeHeader("Swimwear");
        //changeEmptyViewText(mRecyclerView);

        cancelDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                helperCancelDelete(swimwearAdapterer);
            }
        });
        ...
        swimwearAdapterer = new SwimwearAdapter(this);
        mRecyclerView.setAdapter(swimwearAdapterer);
        swimwearAdapterer.setListener(this);



        mDatabaseReference = FirebaseDatabase.getInstance().getReference(FirebaseMethods.getUserUid()).child("Swimwear");

        mDatabaseTagRef = FirebaseDatabase.getInstance().getReference(FirebaseMethods.getUserUid() + "/Tags/");


        mDatabaseListener = FirebaseMethods.returnGalleryListener(mDatabaseReference, Swimwear.class, swimwearAdapterer);
    }
    ...
    public void changeEmptyViewText(EmptyRecyclerView emptyRecyclerView) {
        ...
        textView.setText("Add more Swimwear");
    }
